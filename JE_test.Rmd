...
df = df.reset_index()
# df.index.format   
# <string>:1: FutureWarning: RangeIndex.format is deprecated and will be removed in a future version. Convert using index.astype(str) or index.map(formatter) instead.
df.index.astype(str)
```
